...
public class CommonEnum {
	...
	public enum XFormDataProviders {
        X_FORM_DP_PROFILES_MANAGEMENT("0"),//number of excel sheet
        X_FORM_DP_GENERAL_ACTIVITIES_MANAGEMENT("1"),
        X_FORM_DP_GENERAL_USER_INTERFACE_MANAGEMENT("2"),
        X_FORM_DP_GENERAL_SERVICES_MANAGEMENT("3"),
        XFROM_DP_ACCESS_AND_SECURITY_MANAGEMENT("4"),
        X_FORM_DP_SYSTEM_ADMINISTRATION_MANAGEMENT("5"),
        X_FORM_DP_TENANTS_MANAGEMENT("6"),
        X_FORM_DP_USER_MANAGEMENT("7"),
        X_FORM_DP_NOTIFICATIONS_MANAGEMENT("8"),
        X_FORM_DP_EVENTS_MANAGEMENT("9"),
        X_FORM_DP_SEARCH_MANAGEMENT("10");
