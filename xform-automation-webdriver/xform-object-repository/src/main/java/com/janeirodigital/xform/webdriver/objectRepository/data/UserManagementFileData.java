...
import com.janeirodigital.xform.webdriver.objectRepository.data.BaseTCData;
import com.poiji.annotation.ExcelCell;
import com.poiji.option.PoijiOptions;

public class UserManagementFileData extends BaseTCData {
    @ExcelCell(0)
    private String sId;
    @ExcelCell(1)
    ...
    public UserManagementFileData(){
        PoijiOptions options = PoijiOptions.PoijiOptionsBuilder.settings()
                .sheetIndex(Integer.valueOf(String.valueOf(CommonEnum.XFormDataProviders.X_FORM_DP_USER_MANAGEMENT))) //8th sheet from .xlsx file
                .build();
    }
