...
import com.janeirodigital.xform.webdriver.scripts.AccessAndSecurity;
...
public class TestListener extends AccessAndSecurity implements ITestListener {
    ...
    private String getFullPath(String methodName, Object currentClass) throws Exception {
        String filePath =((AccessAndSecurity) currentClass).common.getValueFromConfig(XmlEnum.SCREEN_SHOOTS.getTagName());
        String sFullPath;
        String sBrowserName;
